...
// Conteneur resserré, identique aux autres listes
...
export default function DevisAutrePage() {
  ...
  // Recherche (même design que la page Catégories)
  ...
  // Filtrage local (N°, client, date lisible)
  const filtered = useMemo(() => {
    ...
    return items.filter((d) => {
      ...
      // on matche aussi sur la date locale 'jj/mm/aaaa'
      let dateStr = "";
      try {
  ...
  // Ajuster la page si on dépasse (quand pageSize / filtre change)
  useEffect(() => {
