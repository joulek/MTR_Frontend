...
// Conteneur resserré (même design que traction/torsion)
...
export default function DevisCompressionList() {
  ...
  // Recherche (même design que l’autre page)
  ...
  // Charger la liste des devis (compression)
  ...
  // Filtrage local par N°, Client, Date (jj/mm/aaaa)
  ...
  // Clamp page si filtered/pageSize changent
  useEffect(() => {
  ...
  return (
    <div className="py-6 space-y-4">
      ...
      <div className={WRAP}>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <h1 className="text-xl sm:text-2xl font-extrabold tracking-tight text-[#0B1E3A]">
            Demande de devis – Ressort de Compression
          </h1>
      ...
      {/* Table seule (compacte, responsive, sans carte blanche) */}
      <div className={WRAP}>
        {loading ? (
              ...
              <div className="overflow-x-hidden">
                <table className="w-full table-fixed text-sm border-separate border-spacing-0">
                 ...
                 px-2 py-0.5 text-[11px] hover:bg-[#0B1E3A]/5"
                          ...
                          {/* Fichiers joints: seulement “Ouvrir” */}
                          <td className="p-2 align-top border-b border-gray-200">
                            {docs.length === 0 ? (
