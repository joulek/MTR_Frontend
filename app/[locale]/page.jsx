              ...
              <div className="grid gap-6">
                <article className="rounded-3xl border-2 border-[#F4D06F] bg-white p-6 shadow-sm transition hover:shadow-lg hover:shadow-[#F4D06F]/20">
                  ...
                  <p className="leading-relaxed text-slate-700">
                    ...
                    <strong> Manufacture Tunisienne des Ressorts (MTR)</strong> est une entreprise tunisienne de
                    type SARL, spécialisée depuis plus de 30 ans dans la conception et la fabrication de ressorts :
          ...
          <div className="grid gap-6 md:grid-cols-3 -mt-6 md:-mt-10">
            ...
            >
              ...
              <div className="mt-4 flex flex-wrap gap-2 text-xs">
                {["Automobile", "Électroménager", "Agriculture", "Électricité", "Bâtiment", "Sports & loisirs"].map(
                  (t) => (
                    <span key={t} className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-slate-700">
                      {t}
                    </span>
                  )
                )}
      ...
      <section id="contact" className="relative overflow-hidden bg-slate-50 py-20">
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="mx-auto mb-12 max-w-3xl text-center">
            ...
            <p className="mt-3 text-slate-600">
              Une question technique, un devis ou un prototype à lancer ? Notre équipe vous répond rapidement.
            </p>
          </div>
              ...
              >
                <div className="grid gap-5 sm:grid-cols-2">
                  <div className="relative">
                    ...
                    <label
                      htmlFor="nom"
                      className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 bg-white px-2 text-sm text-slate-500 transition-all peer-focus:top-0 peer-focus:-translate-y-1/2 peer-focus:text-[#0B2239] peer-[&:not(:placeholder-shown)]:top-0 peer-[&:not(:placeholder-shown)]:-translate-y-1/2"
                    >
                      Nom complet
                    </label>
                  </div>
                  ...
                  <div className="relative sm:col-span-2">
                    ...
                    <label
                      htmlFor="message"
                      className="pointer-events-none absolute left-3 top-6 bg-white px-2 text-sm text-slate-500 transition-all peer-focus:top-0 peer-focus:-translate-y-1/2 peer-focus:text-[#0B2239] peer-[&:not(:placeholder-shown)]:top-0 peer-[&:not(:placeholder-shown)]:-translate-y-1/2"
                    >
                      Message
                    </label>
                  </div>
                ...
                <div className="mt-6 flex flex-wrap items-center justify-between gap-4">
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center gap-2 rounded-full bg-[#F5B301] px-7 py-3 font-semibold text-[#0B2239] shadow hover:brightness-95"
                  >
